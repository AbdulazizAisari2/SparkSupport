      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-2xl">
            <p className="text-sm font-medium text-ink mb-2">Demo Accounts:</p>
            <div className="space-y-2 text-xs text-muted">
              <div>Customer: john@customer.com</div>
              <div>Staff: sarah@company.com</div>
              <div>Admin: admin@company.com</div>
              <div className="mt-2 text-gray-500">Password: password</div>
            </div>
          </div>
        </CardContent>
      </Card>
